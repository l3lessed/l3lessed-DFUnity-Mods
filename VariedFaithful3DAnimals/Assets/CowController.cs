    ...
    public class CowController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            foreach (SkinnedMeshRenderer animalSkinnedMesh in animalSkinnedMeshArray)
            {
                ...
                animalSkinnedMesh.material.mainTexture = VariedAnimalsControls.VariedAnimalsControlsInstance.CowTextureList[UnityEngine.Random.Range(0, VariedAnimalsControls.VariedAnimalsControlsInstance.CowTextureList.Count - 1)];
            }
        }
