    ...
    public class CamelController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            foreach (SkinnedMeshRenderer animalSkinnedMesh in animalSkinnedMeshArray)
            {
                ...
                animalSkinnedMesh.material.mainTexture = VariedAnimalsControls.VariedAnimalsControlsInstance.CamelTextureList[UnityEngine.Random.Range(0, VariedAnimalsControls.VariedAnimalsControlsInstance.CamelTextureList.Count - 1)];
            }
        }
