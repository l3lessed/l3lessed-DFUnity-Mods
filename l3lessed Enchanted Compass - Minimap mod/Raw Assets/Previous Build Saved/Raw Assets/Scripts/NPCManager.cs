...
namespace Minimap
{
    public class NPCManager : MonoBehaviour
    {
        ...
        public static Dictionary<Minimap.MarkerGroups, Material> npcMaterialDict;
        public static Dictionary<Minimap.MarkerGroups, Material> npcIconMaterialDict;
        #endregion

        private void Start()
        {
            npcMaterialDict = new Dictionary<Minimap.MarkerGroups, Material>()
            {
                {Minimap.MarkerGroups.Friendlies, new Material(Minimap.buildingMarkerMaterial) },
                {Minimap.MarkerGroups.Enemies, new Material(Minimap.buildingMarkerMaterial) },
                {Minimap.MarkerGroups.Resident, new Material(Minimap.buildingMarkerMaterial) },
                {Minimap.MarkerGroups.None, new Material(Minimap.buildingMarkerMaterial) }
            };
