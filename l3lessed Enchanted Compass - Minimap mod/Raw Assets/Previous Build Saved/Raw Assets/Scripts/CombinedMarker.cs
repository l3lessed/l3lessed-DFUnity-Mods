...
namespace Minimap
{
    public class CombinedMarker : MonoBehaviour
    {
        ...
        {            
            ...
            if (timePass > .1f)
            {
                ...
                if (Minimap.minimapControls.smartViewActive)
                {
                    ...
                    {
                        marker.attachedIcon.SetActive(Minimap.iconGroupActive[marker.iconGroup]);
            ...
            {
                marker.attachedIcon.transform.position = marker.iconPosition + new Vector3(-1.5f, 4f, -1.5f);
            ...
            {
                marker.attachedIcon.transform.position = marker.iconPosition + new Vector3(0, 4f, 0);
            ...
            if (lastColor != Minimap.iconGroupColors[marker.iconGroup])
            {
                lastColor = Minimap.iconGroupColors[marker.iconGroup];
                //updateMaterials(marker.attachedMesh, Minimap.iconGroupColors[marker.iconGroup], Minimap.iconGroupTransperency[marker.iconGroup]);
            }
        ...
        void GenerateMarker()
        {
            ...
            marker.attachedIcon.transform.position = marker.iconPosition + new Vector3(0, 1f, 0); ;
            ...
            if (marker.questActive)
            {
                ...
                marker.attachedQuestIcon.transform.position = marker.iconPosition + new Vector3(-2.5f, 2f, -2.5f);
            ...
            marker.attachedLabel.transform.position = marker.iconPosition + new Vector3(0, .3f, 0);
        ...
        static void updateMaterials(GameObject objectWithMat, Color materialColor, float DistortionBlend)
        {
