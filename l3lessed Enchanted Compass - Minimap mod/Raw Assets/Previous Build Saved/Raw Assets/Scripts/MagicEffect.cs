...
namespace Minimap
{
    public class MagicEffect : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            lifeTime = Minimap.randomNumGenerator.Next(2, 8);
            ...
            Vector3 magicEffectPosition = new Vector3(Minimap.randomNumGenerator.Next((int)(Minimap.MinimapInstance.minimapSize * -.5f), (int)(Minimap.MinimapInstance.minimapSize * .5f)), Minimap.randomNumGenerator.Next((int)(Minimap.MinimapInstance.minimapSize * -.5f), (int)(Minimap.MinimapInstance.minimapSize * .5f)), 0);
            ...
            swirlScale = Minimap.randomNumGenerator.Next((int)(Minimap.MinimapInstance.minimapSize * .25f), (int)(Minimap.MinimapInstance.minimapSize * .45f));
        }
        ...
        void Update()
        {
            ...
            else if(reverseEffect)
            {
                ...
                if(deathTimer > updateTimer + Minimap.MinimapInstance.fpsUpdateInterval)
                {
