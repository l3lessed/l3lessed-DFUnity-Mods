        ...
        private void Start()
        {
            ...
            if (mobileNPC != null)
            {
                ...
                else
                {
                    ...
                    {
                        case Races.Redguard:
                            textures = (mobileNPC.Gender == Genders.Male) ? Minimap.maleRedguardTextures : Minimap.femaleRedguardTextures;
                            break;
                        case Races.Nord:
                            textures = (mobileNPC.Gender == Genders.Male) ? Minimap.maleNordTextures : Minimap.femaleNordTextures;
                            break;
                        case Races.Breton:
                        default:
                            textures = (mobileNPC.Gender == Genders.Male) ? Minimap.maleBretonTextures : Minimap.femaleBretonTextures;
                            break;
                    }
                }
