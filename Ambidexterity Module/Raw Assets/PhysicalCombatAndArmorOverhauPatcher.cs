...
{
    public class PhysicalCombatArmorPatch : MonoBehaviour
    {
        public static PhysicalCombatArmorPatch PhysicalCombatArmorPatchInstance;
        static Mod mod;
        ...
        public static bool IsRingOfNamira(DaggerfallUnityItem item)
        {
