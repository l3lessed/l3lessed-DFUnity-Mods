...
namespace AmbidexterityModule
{
    public class OffHandFPSWeapon : MonoBehaviour
    {
        ...
        public static DaggerfallUnityItem equippedOffHandFPSWeapon;
        ...
        public static SoundClips SwingWeaponSound = SoundClips.SwingMediumPitch;
                ...
                else if (false && !isParrying)
                {
                    if (weaponState == WeaponStates.StrikeLeft)
                    {
                        if (WeaponType == WeaponTypes.Flail || WeaponType == WeaponTypes.Flail_Magic)
                        {
                            if (currentFrame <= 1)
                            {
                                curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[3].startIndex + 3];
                        ...
                        else if (WeaponType == WeaponTypes.Dagger || WeaponType == WeaponTypes.Dagger_Magic)
                        {
                            if (currentFrame <= 1)
                            {
                                curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[2].startIndex + 2];
                    ...
                    else if (weaponState == WeaponStates.StrikeRight)
                    {
                        if (WeaponType == WeaponTypes.Flail || WeaponType == WeaponTypes.Flail_Magic)
                        {
                            if (currentFrame <= 1)
                            {
                                curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[4].startIndex + 3];
                        ...
                        else if (WeaponType == WeaponTypes.Dagger || WeaponType == WeaponTypes.Dagger_Magic)
                        {
                            if (currentFrame <= 1)
                            {
                                curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[5].startIndex + 2];
                                weaponAnimRecordIndex = 5;
                                offsetX = posi - .25f;
                            }
                            else
                        ...
                        {
                            curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[5].startIndex + currentFrame];
                            weaponAnimRecordIndex = 5;
                            if (currentFrame < 6)
                                offsetY = (posi / 3) * -1;
                            offsetX = (posi * -1) + .3f;
                    ...
                    else if (weaponState == WeaponStates.StrikeDown)
                    {
                        if (WeaponType == WeaponTypes.Flail || WeaponType == WeaponTypes.Flail_Magic)
                        {
                            if (currentFrame <= 1)
                            {
                                curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[1].startIndex + 2];
                            ...
                            {
                                curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[6].startIndex + 1];
                                weaponAnimRecordIndex = 6;
                                offsetX = (posi / 3) - .05f;
                                offsetY = (posi * -1) - .1f;
                            }
                        ...
                        {
                            curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[3].startIndex + currentFrame];
                            curAnimRect = new Rect(curAnimRect.xMax, curAnimRect.yMin, -curAnimRect.width, curAnimRect.height);
                            weaponAnimRecordIndex = 3;
                            if (currentFrame < 3)
                                offsetY = posi - .14f;
                    ...
                    else if (weaponState == WeaponStates.StrikeUp)
                    {
                        ...
                        {
                            curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[1].startIndex + currentFrame];
                            weaponAnimRecordIndex = 1;
                            if (currentFrame < 3)
                                offsetY = posi - .1f;
                            else
                        ...
                        else if (WeaponType == WeaponTypes.Staff || WeaponType == WeaponTypes.Staff_Magic)
                        {
                            if (currentFrame <= 1)
                            {
                                curAnimRect = isImported ? new Rect(1, 0, -1, 1) : weaponRects[weaponIndices[0].startIndex];
                                weaponAnimRecordIndex = 0;
                                offsetX = .25f;
                                offsetY = (posi * -1) * 2.2f;
                            }
